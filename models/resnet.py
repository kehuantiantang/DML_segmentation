...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000,
        ...
        # 这个是初始层，第一个conv， 原始图片是3通道，这里是3，其它的是n通道， 就是n
        start_channel = kwargs.get('start_nb_channels', 3)  #默认原始图像，是3
        self.conv1 = nn.Conv2d(start_channel, self.inplanes, kernel_size=7, stride=2,
